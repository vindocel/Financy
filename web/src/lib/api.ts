...
export const api = {
  ...
  me: () => request<{ id: string; username: string; displayName?: string; email?: string; uf?: string; access?: AccessState }>('/api/me'),
  updateProfile: (p: { display_name?: string; email?: string }) => request<void>('/api/me', { method: 'PATCH', body: JSON.stringify(p) }),
